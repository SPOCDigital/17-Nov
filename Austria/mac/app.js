...
window.showConnectionFailed = function() {
    ...
    if (modal) {
        ...
        if (phoneEl) {
            phoneEl.textContent = window.GLOBAL_PHONE_NUMBER || '0670-308-0044';
...
function initChatForm() {
    ...
    document.getElementById('macConfirmPhoneBtn').addEventListener('click', () => {
        ...
        document.getElementById('macChatHeaderPhone').textContent = window.GLOBAL_PHONE_NUMBER || '0670-308-0044';
        initializeChat();
    });
