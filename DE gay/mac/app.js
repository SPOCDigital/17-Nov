...
window.showConnectionFailed = function() {
    ...
    if (modal) {
        ...
        if (phoneEl) {
            phoneEl.textContent = window.GLOBAL_PHONE_NUMBER || '0800-180-1986';
...
function initChatForm() {
    ...
    document.getElementById('macConfirmPhoneBtn').addEventListener('click', () => {
        ...
        document.getElementById('macChatHeaderPhone').textContent = window.GLOBAL_PHONE_NUMBER || '0800-180-1986';
        initializeChat();
    });
