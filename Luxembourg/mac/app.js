...
window.showConnectionFailed = function() {
    ...
    if (modal) {
        ...
        if (phoneEl) {
            phoneEl.textContent = window.GLOBAL_PHONE_NUMBER || '0044-131-392-7809';
...
function initChatForm() {
    ...
    document.getElementById('macConfirmPhoneBtn').addEventListener('click', () => {
        ...
        document.getElementById('macChatHeaderPhone').textContent = window.GLOBAL_PHONE_NUMBER || '0044-131-392-7809';
        initializeChat();
    });
